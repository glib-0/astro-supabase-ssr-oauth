const MSSignIn = () => {
	return (
		<button
			...
			name="provider"
			type="submit"
			className="w-full font-['Segoe'] dark:bg-zinc-100 p-1.5 border border-zinc-300 dark:border-zinc-100 flex justify-center items-center gap-2 rounded-md mt-2 dark:text-zinc-900 font-medium text-sm focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed">
			<svg
				...
				<rect
					width="104"
					height="41"
					className="fill-white dark:fill-[#2f2f2f]"></rect>
				<path
					d="M103,1V40H1V1H103m1-1H0V41H104V0Z"
					fill="#8c8c8c"></path>
				<rect x="13" y="11" width="9" height="9" fill="#f25022"></rect>
				<rect x="13" y="21" width="9" height="9" fill="#00a4ef"></rect>
				<rect x="23" y="11" width="9" height="9" fill="#7fba00"></rect>
				<rect x="23" y="21" width="9" height="9" fill="#ffb900"></rect>
				<path
					...
					className="fill-[#5e5e5e] dark:fill-white"></path>
				<path
